...
from minerva_analysis.server.utils import (
...
def delete_with_datasource_name(config_name):
    ...
    return render_template(
        "index.html", data={"datasource": "", "datasources": get_config_names()}
    )
...
def edit_config_with_config_name(config_name):
    ...
    with open(config_json_path, "r+") as configJson:
        ...
        data["substring"] = mostFrequentLongestSubstring.find_substring(
            header_full_names
        )
                ...
                if request.form.get("name-1") is None or not request.form.get("name-1"):
                    ...
                    for i in range(1, int((len(request.form) - 2) / 3) + 1):
                        ...
                        neighborhood_radius = int(
                            request.form.get("neighborhood_radius")
                        )
                        ...
                        current_task = (
                            "Converting OME-TIFF Channels (This Will Take a While)"
                        )
                        ...
                        header_full_names = [
                            elem["fullName"] for elem in full_csv_header
                        ]
                        config_data["substring"] = (
                            mostFrequentLongestSubstring.find_substring(
                                header_full_names
                            )
                        )
                        ...
                        config_data["channelFile"] = channel_info['filePath']
...
def channel():
    test_data = {}
    test_data["csvHeader"] = [
        "A488_background_none_1Nuclei",
        "A555_background_none_2Nuclei",
        "A555_Alexa555_18Nuclei",
        "A647_background_none_3Nuclei",
        "CATENIN_Alexa647_19Nuclei",
        "CD3_Alexa555_10Nuclei",
        "CD45RO_Alexa488_13Nuclei",
        "CD45_Alexa555_30Nuclei",
        "CD4_Alexa488_9Nuclei",
        "CD8_Alexa647_11Nuclei",
        "DNA2_Hoechst33342_4Nuclei",
        "DNA3_Hoechst33342_8Nuclei",
        "DNA4_Hoechst33342_12Nuclei",
        "DNA5_Hoechst33342_16Nuclei",
        "DNA6_Hoechst33342_20Nuclei",
        "DNA7_Hoechst33342_24Nuclei",
        "DNA8_Hoechst33342_28Nuclei",
        "DNA9_Hoechst33342_32Nuclei",
        "DNA_Hoechst33342_0Nuclei",
        "ECAD_Alexa488_17Nuclei",
        "FOXP3_Alexa555_14Nuclei",
        "HES1_Alexa647_27Nuclei",
        "KERATIN_Alexa555_26Nuclei",
        "KI67_Alexa488_5Nuclei",
        "MITF_Alexa488_25Nuclei",
        "NGFR_Alexa647_23Nuclei",
        "PD1_Alexa647_15Nuclei",
        "PDL1_Alexa647_7Nuclei",
        "S100_Alexa488_33Nuclei",
        "SMA_Alexa647_35Nuclei",
        "VEGFR2_Alexa555_34Nuclei",
        "VIMENTIN_Alexa555_6Nuclei",
        "cJUN_Alexa488_21Nuclei",
        "pERKz_Alexa647_31Nuclei",
        "pRB_Alexa555_22Nuclei",
        "pS6_Alexa488_29Nuclei",
        "NucleusArea",
        "CellPosition_X",
        "CellPosition_Y",
    ]
    test_data["datasetName"] = "channelConfigs"
    test_data["substring"] = mostFrequentLongestSubstring.find_substring(
        test_data["csvHeader"]
    )
    test_data["channelFileNames"] = [
        "ID",
        "X Position",
        "Y Position",
        "channel_01",
    ...
    with open(config_json_path, "r+") as configJson:
        ...
        for originalData in combinedOriginalData:
            ...
            if normalizeCsv:
                ...
                pre_normalization.preNormalize(
                    csvPath, normPath, skip_columns=skip_columns
                )
            ...
            if "celltypeData" in originalData:
                ...
                configData[datasetName]["featureData"][0]["celltype"] = headerList[2][
                    1
                ]["value"]
            configData[datasetName]["featureData"][0]["xCoordinate"] = headerList[0][1][
                "value"
            ]
            configData[datasetName]["featureData"][0]["yCoordinate"] = headerList[1][1][
                "value"
            ]
            ...
            if "idField" in request.json:
                channelList.pop(0)
                configData[datasetName]["featureData"][0]["idField"] = request.json[
                    "idField"
                ][1]["value"]
            ...
            if "neighborhood_radius" in originalData:
                configData[datasetName]["neighborhood_radius"] = originalData[
                    "neighborhood_radius"
                ]
            ...
            if "normalization" in originalData:
                configData[datasetName]["featureData"][0]["normalization"] = (
                    originalData["normalization"]
                )

            configData[datasetName]["featureData"][0]["src"] = str(
                data_path / datasetName / csvName
            )
            ...
            for i in range(len(channelList)):
                ...
                channelData = {}
                channelData["src"] = (
                    "/generated/data/" + datasetName + "/" + channel + "/"
                )
